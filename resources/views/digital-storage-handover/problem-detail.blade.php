    ...
    <form id="form-data">
        ...
        @if($collection->TITLE_PARENT)
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="ph-link me-2 text-muted"></i>
                        <div class="flex-fill">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code" value="{{ $collection->CODE }}" placeholder="Masukkan kode identifier" readonly>
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">
                                <div class="form-check form-check-inline mb-0">
                                    <input type="checkbox" class="form-check-input" onchange="$(this).is(':checked') ? $('#qrcbn').attr('readonly', true) : $('#qrcbn').attr('readonly', false)" {{ $collection->QRCBN ? '' : 'checked' }}>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <span class="input-group-text">
                                <div class="form-check form-check-inline mb-0">
                                    <input type="checkbox" class="form-check-input" id="series_checkbox" onchange="$(this).is(':checked') ? $('#series').attr('readonly', true) : $('#series').attr('readonly', false)" {{ $collection->SERIES ? '' : 'checked' }}>
                                    <label class="form-check-label">Tidak Ada</label>
                                </div>
                            </span>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <select class="form-select w-auto flex-grow-0" name="currency" id="currency" style="max-width: 120px;">
                ...
                <div class="row g-3">
                    <div class="col-lg-6">
                        <div class="border rounded p-3">
                            ...
                            <div class="form-group">
                                <label class="form-label">Upload Ulang Cover</label>
                    ...
                    <div class="col-lg-6">
                        <div class="border rounded p-3">
                            ...
                            <div class="form-group">
                                <label class="form-label">Upload Ulang Konten</label>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success" onclick="submitted(3)">
    ...
    $(document).ready(function() {
        ...
        if(rawFilename) {
            ...
            $('#default-message').html(`
                <i class="ph-file ph-3x text-muted"></i>
                <span class="text-muted">File konten tidak tersedia.</span>
            `);
        }
    });
        ...
        switch (ext) {
            ...
            default:
                $('#default-message').show().html(`
                    ...
                    <span class="text-muted">Preview tidak didukung untuk format: .${ext}</span>
                `);
        ...
        const checkPdfLib = setInterval(function() {
            if (window.pdfjsLib) {
                ...
                window.pdfjsLib.getDocument(url).promise.then(function(pdf) {
                    ...
                    $('#default-message').show().html(`
                        <i class="ph-warning-circle ph-3x text-danger"></i>
                        <span class="text-muted">Gagal memuat PDF.</span>
                    `);
