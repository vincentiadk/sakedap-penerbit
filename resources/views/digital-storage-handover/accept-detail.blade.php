    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Serah Simpan Digital - Koleksi Diterima - <span class="fw-normal">Detail</span>
            </h4>
        </div>
        <div class="d-lg-flex ms-lg-auto">
            <div class="d-flex align-items-center gap-2">
                ...
                <button type="button" class="btn btn-info" onclick="lookupCatalogHistory('CATALOGS', {{ $collection->ID }})">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-text">
                            <i class="ph-info me-1"></i>
                            Format: Untuk halaman gunakan format "1-5", untuk video gunakan format "00:01-00:20"
                        </div>
                    </div>
                </div>
                <div class="row form-group">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-0">
                        ...
                        Pastikan preview sudah sesuai sebelum menyimpan data
                    </p>
                </div>
                <div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(rawFilename) {
            ...
            $('#default-message').show().find('span').text('File konten tidak tersedia.');
        }
    });
    ...
    function submitted() {
        $.ajax({
            url: '{{ url("digital-storage-handover/accept/detail/$collection->ID") }}',
            type: 'POST',
            dataType: 'JSON',
