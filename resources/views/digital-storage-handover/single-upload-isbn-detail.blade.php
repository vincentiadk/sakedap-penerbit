    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Serah Simpan Digital - Unggah Tunggal ISBN - <span class="fw-normal">Ubah Data</span>
            </h4>
        </div>
        <div class="d-lg-flex ms-lg-auto">
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{ url('digital-storage-handover/single-upload-isbn') }}" class="btn btn-primary">
...
<div class="content pt-0">
    ...
    <form id="form-data">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-semibold">
                        <i class="ph-warning-octagon me-1 text-danger"></i>
                        Histori Masalah
                    </h5>
                    @if($collection->REVISION_COUNT)
                        <span class="badge bg-danger bg-opacity-10 text-danger px-3 py-2">
                            <i class="ph-arrow-counter-clockwise me-1"></i>
                            {{ $collection->REVISION_COUNT }} Kali Dilakukan Revisi
                        </span>
                    @else
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        <thead class="table-light">
                            <tr>
                                <th style="width: 50%;">Nama Masalah</th>
            ...
            <div class="card-body">
                <div class="alert alert-info border-0 mb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>{{ $collection->ALIAS_WORKSHEET }}</strong>
                            <div class="text-muted small">{{ $collection->CATEGORY_WORKSHEET }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="alert alert-primary border-0 mb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>{{ $collection->TITLE_PARENT }}</strong>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                @if($collection->TITLE_PARENT)
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="edition" id="edition" value="{{ $collection->EDITION }}" placeholder="Masukkan edisi koleksi">
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-form-label col-md-3 fw-semibold">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control date-picker-single" name="edition_date" id="edition_date" value="{{ $collection->EDITION_DATE ? date('d/m/Y', strtotime($collection->EDITION_DATE)) : '' }}" placeholder="Pilih Tanggal">
                            </div>
                        </div>
                    </div>
                @endif
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <select class="form-select select2-basic" name="collection_media_id" id="collection_media_id" onchange="getCategory()" data-placeholder="Pilih Jenis Koleksi">
                            <option value=""></option>
                            @foreach($media as $m)
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="title" id="title" value="{{ $collection->TITLE }}" placeholder="Masukkan judul koleksi">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-form-label col-md-3 fw-semibold">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control date-picker-single" name="publish_time" id="publish_time" placeholder="Pilih Tanggal" value="{{ ($collection->PUBLICATION_DAY && $collection->PUBLICATION_MONTH && $collection->PUBLICATION_YEAR) ? $collection->PUBLICATION_YEAR . '/' . $collection->PUBLICATION_MONTH . '/' . $collection->PUBLICATION_DAY : '' }}">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-text">
                            <i class="ph-info me-1"></i>
                            Format: halaman (1-5) atau waktu (00:01-00:20)
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <select class="form-select w-auto flex-grow-0" name="currency" id="currency" style="max-width: 150px;">
                                <option value="{{ $collection->CURRENCY }}" selected>{{ $collection->CURRENCY }}</option>
                            </select>
                            <input type="number" class="form-control" name="price" id="price" value="{{ $collection->PRICE }}" placeholder="Masukkan harga jual" min="0">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="binding" id="binding" value="{{ $collection->JILID }}" placeholder="Masukkan informasi jilid">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-form-label col-md-3 fw-semibold">
                        ...
                        <div class="row g-2">
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="physical_description[paging]" id="physical_description[paging]" value="{{ isset($physicalDescription->paging) ? $physicalDescription->paging : '' }}" placeholder="Jumlah">
                                    <select class="form-select flex-grow-0 w-auto" name="physical_description[paging_flag]" id="physical_description[paging_flag]" style="max-width: 120px;">
                                        <option value="Halaman" {{ isset($physicalDescription->paging_flag) ? ($physicalDescription->paging_flag == 'Halaman' ? 'selected' : '') : 'selected' }}>Halaman</option>
                            ...
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="physical_description[ill]" list="suggestion-physical-description-ill" id="physical_description[ill]" value="{{ isset($physicalDescription->ill) ? $physicalDescription->ill : '' }}" placeholder="Pilih atau ketik" autocomplete="off">
                            ...
                            <div class="col-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="physical_description[sizes]" id="physical_description[sizes]" value="{{ isset($physicalDescription->sizes) ? $physicalDescription->sizes : '' }}" placeholder="Contoh: 21 x 14 cm">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <textarea name="description" class="form-control" id="description" rows="5" placeholder="Masukkan sinopsis atau deskripsi koleksi">{{ $collection->DESCRIPTION }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="form-check form-group">
                    <input type="radio" class="form-check-input" name="access" id="access-1" value="1" {{ $collection->AKSES == 1 ? 'checked' : '' }}>
                ...
                <div class="form-check form-group">
                    <input type="radio" class="form-check-input" name="access" id="access-2" value="2" {{ $collection->AKSES == 2 ? 'checked' : '' }}>
                ...
                <div class="form-check form-group">
                    <input type="radio" class="form-check-input" name="access" id="access-3" value="3" {{ $collection->AKSES == 3 ? 'checked' : '' }}>
                ...
                <div class="form-check form-group">
                    <input type="radio" class="form-check-input" name="access" id="access-4" value="4" {{ $collection->AKSES == 4 ? 'checked' : '' }}>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <select class="form-select" name="author[]" id="author" data-placeholder="Ketik nama kontributor (Penulis, Editor, dll)" multiple>
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0 fw-semibold">
                    <i class="ph-files me-1 text-info"></i>
                    File Koleksi
                </h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="form-label fw-semibold">Upload Ulang (Opsional)</label>
                                    <input type="file" class="form-control" name="file_cover" id="file_cover">
                                    <div class="form-text">
                                        <i class="ph-info me-1"></i>
                                ...
                                <div class="alert alert-info border-0">
                                    <div class="fw-semibold mb-2">Informasi File Saat Ini:</div>
                                    <div class="small">
                                        <div><strong>Hash:</strong> {{ $collection->HASH_CATALOGCOVERS ?? '-' }}</div>
                                        <div><strong>Mime Type:</strong> {{ $collection->MIME_CATALOGCOVERS ?? '-' }}</div>
                                        <div><strong>Ukuran:</strong> {{ Main::formatFileSize($collection->FILE_SIZE_CATALOGCOVERS ?? 0) }}</div>
                                        <div><strong>Metode:</strong> {{ Main::method($collection->METHOD_CATALOGCOVERS ?? 0) }}</div>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <img src="" class="img-fluid rounded shadow-sm" id="file-cover" style="object-fit: contain; max-width: 100%; max-height: 400px;" alt="Cover Catalog">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info border-0">
                                    <div class="fw-semibold mb-2">Informasi File Saat Ini:</div>
                                    <div class="small">
                                        <div><strong>Hash:</strong> {{ $collection->HASH_CATALOGFILES ?? '-' }}</div>
                                        <div><strong>Mime Type:</strong> {{ $collection->MIME_CATALOGFILES ?? '-' }}</div>
                                        <div><strong>Ukuran:</strong> {{ Main::formatFileSize($collection->FILE_SIZE_CATALOGFILES ?? 0) }}</div>
                                        <div><strong>Metode:</strong> {{ Main::method($collection->METHOD_CATALOGFILES ?? 0) }}</div>
                                    </div>
                                </div>
                                <div id="viewer-wrapper" class="border rounded shadow-sm" style="position: relative; width: 100%; min-height: 400px; background: #f5f5f5;">
                                    <div id="viewer-content" style="width: 100%; height: 100%;">
                                        ...
                                        <div id="default-message" style="display: flex; height: 600px; align-items: center; justify-content: center;">
                                            <div class="text-center text-muted">
                                                <i class="ph-spinner ph-2x rotating"></i>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-primary" onclick="submitted(1)">
                        <i class="ph-check-circle me-1"></i>
                        Simpan & Langsung Ajukan
                    </button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if(rawFilename) {
            ...
            $('#default-message').html('<div class="text-center text-muted"><i class="ph-file-x ph-2x mb-2"></i><div>File konten tidak tersedia</div></div>');
        }
    });
    ...
    function loadUniversalViewer(url, ext) {
        ...
        switch (ext) {
            ...
            case 'wav':
                ...
                break;
            default:
                $('#default-message').show().html('<div class="text-center text-muted"><i class="ph-file-x ph-2x mb-2"></i><div>Preview tidak didukung untuk format: .' + ext + '</div></div>');
        ...
        const checkPdfLib = setInterval(function() {
            if (window.pdfjsLib) {
                ...
                window.pdfjsLib.getDocument(url).promise.then(function(pdf) {
                    ...
                    $('#default-message').show().html('<div class="text-center text-muted"><i class="ph-warning-circle ph-2x mb-2"></i><div>Gagal memuat PDF</div></div>');
                    $container.hide();
                });
            }
        }, 100);
    ...
    function submitted(param) {
        $.ajax({
            url: '{{ url("digital-storage-handover/single-upload-isbn/update-data/$collection->ID") }}?param=' + param,
            type: 'POST',
            dataType: 'JSON',
