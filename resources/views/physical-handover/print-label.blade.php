    ...
    <div class="page-header-content d-lg-flex">
        <div class="d-flex">
            <h4 class="page-title mb-0">
                Serah Simpan Fisik - <span class="fw-normal">Cetak Label</span>
            </h4>
        </div>
    </div>
</div>
<div class="content pt-0">
    <div class="card">
        ...
        <div class="card-footer bg-white">
            <div class="text-end">
                <a href="{{ url('physical-handover/print-label') }}" class="btn btn-danger" onclick="onLoading('show', 'body')">
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("physical-handover/print-label/datatable") }}',
                dataType: 'JSON',
                data: function (d) {
